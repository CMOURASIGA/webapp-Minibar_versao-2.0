...
const Input: React.FC<InputProps> = ({ label, error, helperText, ...props }) => {
  return (
    <div className="mb-4 w-full">
      ...
      <input 
        className={`w-full min-h-11 text-base px-4 py-3 rounded-xl border ${error ? 'border-red-500' : 'border-gray-200'} focus:outline-none focus:ring-2 focus:ring-[#1e4d72]/20 transition-all`}
        {...props}
      />
